...
namespace Investimento_Financeiro.investimentos
{
    public class TesouroIPCA
    {
        ...
        public static double taxaFixaMensal = Math.Pow(1 + (FixaAnual), 1.0 / 12.0) - 1;
        public static double ipca = Math.Pow((1 + ipcaAnual), 1.0 / 12.0) - 1;
        public static double taxaMensal = (1 + taxaFixaMensal) * (1 + ipca) - 1;
